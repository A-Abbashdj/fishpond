...
const translations = {
  en: {
    ...
    phTitle: "🌡️ Pond pH",
    tdsTitle: "🧪 Pond TDS",
    temperatureTitle: "🔥 Pond Temperature",
    signal: "Signal",
    updated: "Updated",
    status: "Status",
...
function toggleLanguage() {
  ...
  updateText("temperature-title", t.temperatureTitle);
  ...
  updateText("label-updated-4", t.updated);
  updateText("label-status", t.status);
  updateText("label-status-2", t.status);
  updateText("label-status-3", t.status);
  updateText("label-status-4", t.status);
